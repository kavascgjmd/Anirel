...
function Upload({userData}) {
  ...
  return (
    <div>
        ...
        :
         <Button variant="outlined" onChange={handlechange} fullWidth component="label" startIcon = {<MovieIcon/>} style ={{marginTop : "0.5rem"}}><input style ={{display : "none"}} type="file" accept="audio/*,video/*,image/*" ></input>upload</Button>
